...
const DebridLinkClient = require('./DebridLinkClient')
const DebridLinkTorrent = require('./torrent')
...
class DebridLinkWatcher {
  ...
  addTorrent (file) {
    ...
    const torrent = new DebridLinkTorrent(this.client, this.downloadFn, file, uri)
  ...
  addMagnet (file) {
    ...
    fs.readFile(file, 'utf8', function (err, data) {
      ...
      // Create a torrent instance
      const torrent = new DebridLinkTorrent(self.client, self.downloadFn, file, data)
